            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <form method="POST" action="{{ route('students.update', $student->id) }}" class="max-w-sm mx-auto">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="tipo" id="tipo" value="{{ old('tipo', $student->tipo) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="edad" id="edad" value="{{ old('edad', $student->edad) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="discapacidad" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">discapacidad</label>
                        <input type="text" name="discapacidad" id="discapacidad" value="{{ old('discapacidad', $student->discapacidad) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="enfermedad" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">enfermedad</label>
                        <input type="text" name="enfermedad" id="enfermedad" value="{{ old('enfermedad', $student->enfermedad) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="f_rescate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">f_rescate</label>
                        <input type="date" name="f_rescate" id="f_rescate" value="{{ old('f_rescate', $student->f_rescate) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
